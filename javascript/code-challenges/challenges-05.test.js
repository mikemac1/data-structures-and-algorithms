...
const toLastNames = people => {
  // Solution code here...
  let newArray = people.map((item) => item.firstName + ' ' + item.lastName);
  return newArray;
};
...
const addValues = (arr) => {
  // Solution code here...
  let sum = arr.reduce(function (total, currValue) {
...
const addPurchases = (arr) => {
  // Solution code here...
  let totalPrice = arr.reduce(function (total, item) {
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  return arr.reduce((sum, a) => sum + 1, 0);
};
...
const returnNames = (arr) => {
  // Solution code here...
  let names = arr.reduce((newSWArr, item) => {
    newSWArr.push(item.name);
    return newSWArr;
  }, []);
  return names;
};
